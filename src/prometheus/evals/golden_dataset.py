...
def _tier1_tasks() -> list[GoldenTask]:
    ...
    return [
        ...
        GoldenTask(
            ...
            expected_behavior="Uses bash pwd or similar command, returns a valid directory path",
            expected_tools=["bash"],
        ...
        GoldenTask(
            ...
            expected_behavior="Uses file_read tool to read README.md, returns file contents",
        ...
        GoldenTask(
            ...
            expected_behavior="Uses file_read or bash to read first 10 lines of pyproject.toml",
            expected_tools=["file_read", "bash"],
            tags=["filesystem", "read"],
        ),
        # --- File Write ---
        GoldenTask(
            ...
            expected_behavior="Uses file_write tool to create the file with specified content",
        ...
        GoldenTask(
            ...
            expected_behavior="Uses file_write to create a valid Python script with print statement",
            expected_tools=["file_write"],
        ...
        GoldenTask(
            ...
            expected_behavior="Uses file_write then file_edit to modify the file in place",
...
def _tier2_tasks() -> list[GoldenTask]:
    ...
    return [
        GoldenTask(
            ...
            expected_behavior="Uses file_write to create the file, then file_read to verify contents match",
        ...
        GoldenTask(
            ...
            expected_behavior="Uses glob to find .py files in tracing/, then file_read to show __init__.py contents",
            expected_tools=["glob", "file_read"],
        ...
        GoldenTask(
            ...
            expected_behavior="Creates file, edits it, then uses grep or file_read to confirm the change",
            expected_tools=["file_write", "file_edit", "grep"],
        ...
        GoldenTask(
            ...
            tier=TaskTier.TIER_2,
            input="Create three files in /tmp/: prom_eval_a.txt with 'alpha', prom_eval_b.txt with 'beta', prom_eval_c.txt with 'gamma'. Then list them using glob.",
            expected_behavior="Creates all three files using file_write, then uses glob to list them",
            expected_tools=["file_write", "glob"],
            tags=["filesystem", "multi-step"],
            max_turns=20,
        ),
    ]
