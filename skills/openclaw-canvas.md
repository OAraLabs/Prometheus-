---
name: canvas
description: "Display HTML content on connected OpenClaw nodes (Mac app, iOS, Android). The canvas tool lets you present web content on any connected node's canvas view. Great for displaying games, visualizations, dashboards, showing generated HTML content, and inter"
---
<!-- Provenance: openclaw/openclaw | skills/canvas/SKILL.md | MIT -->
